...
func _on_reset_button_pressed():
	var reset = load("res://Scenes/9level1.tscn").instance()
	add_child(reset)
	remove_child(self)
...
#		$c3/correct.visible = true
	...
	if ($a1.cell_value) == int(0) and ($a2.cell_value) == int(0) and ($a3.cell_value) == int(1) and ($b1.cell_value) == int(1) and ($b2.cell_value) == int(0) and ($b3.cell_value) == int(0) and ($c1.cell_value) == int(0) and ($c2.cell_value) == int(1) and ($c3.cell_value) == int(0):
		var complete = load("res://Scenes/9level1_complete.tscn").instance()
		add_child(complete)
		remove_child(self)
